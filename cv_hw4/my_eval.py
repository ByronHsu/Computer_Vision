...
def main():
    ...
    res = evaluate('./output/tsukuba.png', './testdata/tsukuba/disp3.pgm', scale_factor=16)
    avg += res
    print('Tsukuba: %.2f%%' % (res*100))

    res = evaluate('./output/venus.png', './testdata/venus/disp2.pgm', scale_factor=8)
    avg += res
    print('Venus: %.2f%%' % (res*100))

    res = evaluate('./output/teddy.png', './testdata/teddy/disp2.png', scale_factor=4)
    avg += res
    print('Teddy: %.2f%%' % (res*100))

    res = evaluate('./output/cones.png', './testdata/cones/disp2.png', scale_factor=4)
    avg += res
